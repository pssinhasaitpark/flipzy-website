          ...
          <Col lg={5}>
            <Card className="border-0 shadow-sm rounded-4 sticky-top">
              <Card.Body className="p-4">
                ...
                <div className="mb-4">
                  <h4 className="mb-3 fw-bolder">Select Payment Method</h4>
                  ...
                  <Card className="border-0 shadow-sm rounded-3 mb-2">
                    <Card.Body className="p-3">
                      <div className="d-flex align-items-start gap-3">
                        <div className="bg-light p-2 rounded-circle mr-2">
                          <ShieldCheck size={20} className="text-primary " />
                        </div>
                        <div>
                          <h6 className="mb-1">Free Cancellation</h6>
                          <p className="mb-0 text-muted small">
                            Self-service instant refund anytime before the
                    ...
                    <Card.Body className="p-3">
                      <div className="d-flex align-items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="mb-0 text-muted small">
                            Your money is safe with us until you receive the
