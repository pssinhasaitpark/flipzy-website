...
//                       Closet refresh in progress! Expect pre-loved pieces,
//                       impulse purchases, and items too good to sit in storage.
//                       Style range: comfy, cute, and occasionally confused
//                     </p>
//                   </div>
//                 </div>
...
//                 </div>
//                 <div>
//                   <p className="align-items-center mt-5 mx-2">
//                     dr_sonal_agarwal
//                   </p>
...
const CartDetailsPage = () => {
  ...
  const fetchComments = async (pageNo = 1, reset = true) => {
    try {
      ...
      // Update comments state after API call
      setTimeout(() => {
          ...
          <Col xs={12}>
            ...
            <div>
              ...
              <div className="addComment d-flex ">
                <div className="addComment p-3 bg-light rounded-3 shadow-sm">
                  <form onSubmit={handleSubmit} className="d-flex gap-2">
                    ...
                    <button
                      type="submit"
                      className="btn btn-primary rounded-3 ml-2"
                    >
                      Post
                    </button>
                  </form>
              ...
              {commentsLoading && comments.length === 0 ? (
                ...
                <div className="mx-4 text-center py-4">
