...
// import { BsEye, BsHeart, BsShield, BsChevronRight, BsStar, BsChatDots, BsShare, BsGift } from 'lucide-react';
import {
  BsEye,
  BsHeart,
  BsShield,
...
const ProductPage = () => {
  ...
  // Using placeholder images that represent the denim jacket
  const productImages = [card2, card2, card2];
  const products = [
    {
      id: 1,
  ...
  const productDetails = {
    ...
    size: "Bust 36in",
    description:
      "Elevate your casual look with this classic light blue denim jacket featuring trendy distressed detailing on the front and back. A must-have layering piece for street-style lovers",
    likes: "18",
        ...
        <div className="col-sm-5 ps-4 mt-2">
          ...
          <div className="d-flex align-items-center gap-3 mb-3">
            <div className="d-flex align-items-center gap-1 mx-2">
              <BsEye size={16} className="text-muted m" />
              <small className="text-muted">{productDetails.likes}</small>
            </div>
            <div className="d-flex align-items-center gap-1">
              <BsHeart size={16} className="text-muted" />
              <small className="text-muted">
                Liked by {productDetails.likedBy}
              </small>
            </div>
          </div>

          {/* Product Title */}
          <h2 className="fw-bold mb-3 fs-4">{productDetails.title}</h2>
          ...
          <div className=" mb-2">
            ...
            <div>
              ...
              <span className="text-dark">{productDetails.size}</span>
            </div>
          </div>
              ...
              <div className="d-flex align-items-center justify-content-between">
                <div className="d-flex align-items-start gap-3">
                  <div className="bg-light p-3 rounded-pill">
                    <BsShield className="text-primary" size={18} />
                  </div>
                  <div>
                    <div
                ...
                <BsChevronRight className="text-muted" size={20} />
              </div>
            </Card.Body>
          </Card>
      ...
      <Row className="mt-5">
        <Col xs={12}>
          <div className="">
            ...
            <div className="">
              ...
              <p className="text-muted mb-4 " style={{ fontSize: "14px" }}>
                ...
                purchases, and items too good to sit in storage. Style range:
                comfy, cute, and occasionally confused
              </p>
            </div>
          </div>
          ...
          <div className="d-lg-flex align-items-center gap-4 mb-4 border justify-content-around p-3">
            <div className="d-flex align-items-center gap-1 ">
              <BsStar className="text-warning" size={16} fill="currentColor" />
          ...
          <Card className="border-0 mb-4">
            <Card.Body className="p-3">
              <div className="d-flex align-items-center gap-3 mx-4">
                ...
                >
                  <BsGift className="text-white" size={24} />
                </div>
          ...
          <div className="mb-4">
            ...
            <div className="d-flex align-items-center gap-3 p-3 border-bottom rounded  mx-4">
              ...
              <div className="">
                <p className="align-items-center mt-5 mx-2" style={{}}>
                  dr_sonal_agarwal
                </p>
          ...
          <div>
            ...
            <div className="d-flex align-items-start gap-3 p-3 border-bottom rounded mx-4">
              ...
              <div className="">
                <p className="align-items-center mt-2 mx-2" style={{}}>
                  komal_001
                </p>
                <small className="text-muted">
